...
#parametros de referencia que los dejo para control que no estamso agregando de mas o repitiendo años... en el LASSO Corregido
miny <- 1981
maxy <- 2020
...
for( mes.ref in meses){
 ...
 #Agrego el predcitor nuevo
    ...
    write.xlsx( predictor.agregado,file=paste0("Predictores.",mes.ref,"/Cluster",nclus,"/Predictores_",mes.ref,"_C",nclus,"_LASSO_Corregido.xlsx"))
