...
#=====================================================================================================================
          ...
          if(length(y.pred) != 0){
            ...
            resultado=data.frame(N.Modelo=1:(y.i-1),adjR=y.umbral.modelo,Umbral=rep(umbral,(y.i-1)),Pred.Anio=rep(pred.anio,(y.i-1)),Formula=y.modelo,Tipo=y.tipo.modelo,Prono=round(y.pred,2),obs=as.double(rep(obs.ver,length(Prono))))
            ...
            writeData(wb, sheet = "PronoProba", x = "i.prono", startCol = 20, startRow = 1,rowNames = F)
            writeData(wb, sheet = "PronoProba", x = prono.intervalo, startCol = 20, startRow = 2,rowNames = F)
            ...
            saveWorkbook(wb, file = paste0("./Pronostico/Pronostico_",mes.ref,"_",pred.anio,"_C",nclus,".xlsx"),overwrite = T)
        }
